  ...
  return (
    <div className="space-y-4 md:space-y-6 w-full max-w-full">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 leading-tight">Route Management</h1>
          <p className="text-sm md:text-base text-gray-600 mt-1">Manage bus routes, stops, and schedules</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <div className="flex items-center">
            ...
            <div className="ml-4 min-w-0">
              <p className="text-xs md:text-sm font-medium text-gray-600">Total Routes</p>
              <p className="text-xl md:text-2xl font-bold text-gray-900 leading-tight">{routes.length}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <div className="flex items-center">
            ...
            <div className="ml-4 min-w-0">
              <p className="text-xs md:text-sm font-medium text-gray-600">Active Routes</p>
